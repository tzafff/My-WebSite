...
<a href="moderator.php"> <img src="Εργασία 1/media/java1.png" align="center" style="color:white"></a> <h1>JAVA </h1>
<div class="logo">
...
<nav> 
<ul>
	<li class="selected"> <a href="moderator.php"> ΑΡΧΙΚΗ </a> </li>
...
<h2> Καλωσήλθατε Συντονιστή <?php echo $_SESSION['username']?></h2>
<br>
