...
<td data-label="Όνομα"><?php echo $firstname;?> </td>
<td data-label="Επώνυμο">  <?php echo $lastname;?> </td>
<td data-label="Ηλικία"><?php  echo $age; ?></td>
<td data-label="Φύλλο"><?php echo $gender;?> </td>
<td data-label="Ρόλος"><?php  echo $role; ?></td>
	<!--<td> <a href="change_role.php?role=<?php echo $id;?>" onclick="return confirm('Είσαι σίγουρος?');">Διαγραφή </a> </td>-->	
</tr>
</tbody>
<?php 
	}
...
<br><br><br>
<form name="change" method="post" action="update_role.php">
	Username Χρήστη <input type="text" name="username">  
	<select name="choice">
	<option>Ρόλος</option>
	<option value="1"> User </option>
	<option value="2"> Moderator </option>
	<option value="3"> Administator </option>
	<input type="submit" name="sub" value="Αλλαγή">
</form>
</main>
